...
public class EPLSoccerPlayersPage extends SeleniumUtils{
	...
	private static By lnkPlayerVardy=By.xpath("/html/body/div[3]/div/div/div[2]/div/section/div/div[1]/ul/li[1]/a/div/div[2]/img");
   ...
   public boolean VerifyPlayerInformation(WebDriver driver, Node node,DomParser parser )
	...
	{	   	
	   	...
	   	waitForPageLoad(driver);
	   	waitForPageLoad(driver);
	    Assert.assertTrue(SeleniumUtils.click(driver, lnkPlayerVardy), "Could not click the First Player");
	    waitForPageLoad(driver);
